...
class AnnotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create annotation" do
    assert_difference('Annotation.count') do
      post annotations_url, params: { annotation: { categories: @annotation.categories, ebook_id: @annotation.ebook_id, highlight_ranges: @annotation.highlight_ranges, remark: @annotation.remark, section_id: @annotation.section_id } }
    end
  ...
  test "should update annotation" do
    patch annotation_url(@annotation), params: { annotation: { categories: @annotation.categories, ebook_id: @annotation.ebook_id, highlight_ranges: @annotation.highlight_ranges, remark: @annotation.remark, section_id: @annotation.section_id } }
